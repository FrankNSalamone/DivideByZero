...
print('*                                                                                *')
print('*                                     To The                                     *')
print('*                                Team DivideByZero                               *')
print('*                              Medical Search Engine                             *')
print('*                                   Text Client                                  *')
print('*                                                                                *')
print('*                               CS410 Final Project                              *')
print('*                                                                                *')
print('*                              Connor Brown connorb8                             *')
print('*                                Ray Butler raylb2                               *')
print('*                              Xinlei Huang xhuang84                             *')
print('*                             Frank Salamone frankns2                            *')
print('*                             Jonathan Trusheim  jy38                            *')
print('*                                                                                *')
print('*                                                                                *')
print('*                                                                                *')
print('**********************************************************************************')
